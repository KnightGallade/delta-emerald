...
// Tournament Types
#define PWT_TOURNAMENT_TYPE_HOENN 0
#define PWT_TOURNAMENT_TYPE_ROYALE 1
...
#define PWT_FUNC_BUFFER_BATTLE_STRINGS 11
#define PWT_FUNC_SHOW_OPPONENT_INTRO   12
#define PWT_FUNC_SET_OPPONENT_PARTY    13
// Data to set/get
