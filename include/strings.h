...
extern const u8 gText_SubQuestX_DoneDescX[];
...
// PWT
extern const u8 PWT_Text_Potential1[];
extern const u8 PWT_Text_Potential2[];
extern const u8 PWT_Text_Potential3[];
extern const u8 PWT_Text_Potential4[];
extern const u8 PWT_Text_Potential5[];
extern const u8 PWT_Text_Potential6[];
extern const u8 PWT_Text_Potential7[];
extern const u8 PWT_Text_Potential8[];
extern const u8 PWT_Text_Potential9[];
extern const u8 PWT_Text_Potential10[];
extern const u8 PWT_Text_Potential11[];
extern const u8 PWT_Text_Potential12[];
extern const u8 PWT_Text_Potential13[];
extern const u8 PWT_Text_Potential14[];
extern const u8 PWT_Text_Potential15[];
extern const u8 PWT_Text_Potential16[];
extern const u8 PWT_Text_PotentialDomeAceTucker[];
extern const u8 PWT_Text_StyleRiskDisaster[];
extern const u8 PWT_Text_StyleEndureLongBattles[];
extern const u8 PWT_Text_StyleVariesTactics[];
extern const u8 PWT_Text_StyleToughWinningPattern[];
extern const u8 PWT_Text_StyleUsesVeryRareMove[];
extern const u8 PWT_Text_StyleUsesStartlingMoves[];
extern const u8 PWT_Text_StyleConstantlyWatchesHP[];
extern const u8 PWT_Text_StyleStoresAndLoosesPower[];
extern const u8 PWT_Text_StyleEnfeeblesFoes[];
extern const u8 PWT_Text_StylePrefersLuckTactics[];
extern const u8 PWT_Text_StyleRegalAtmosphere[];
extern const u8 PWT_Text_StylePowerfulLowPPMoves[];
extern const u8 PWT_Text_StyleEnfeebleThenAttack[];
extern const u8 PWT_Text_StyleBattlesWhileEnduring[];
extern const u8 PWT_Text_StyleUpsetsFoesEmotionally[];
extern const u8 PWT_Text_StyleStrongAndStraightforward[];
extern const u8 PWT_Text_StyleAggressivelyStrongMoves[];
extern const u8 PWT_Text_StyleCleverlyDodgesAttacks[];
extern const u8 PWT_Text_StyleUsesUpsettingMoves[];
extern const u8 PWT_Text_StyleUsesPopularMoves[];
extern const u8 PWT_Text_StyleHasPowerfulComboMoves[];
extern const u8 PWT_Text_StyleUsesHighProbabilityMoves[];
extern const u8 PWT_Text_StyleAggressivelySpectacularMoves[];
extern const u8 PWT_Text_StyleEmphasizesOffenseOverDefense[];
extern const u8 PWT_Text_StyleEmphasizesDefenseOverOffense[];
extern const u8 PWT_Text_StyleAttacksQuicklyStrongMoves[];
extern const u8 PWT_Text_StyleUsesAddedEffectMoves[];
extern const u8 PWT_Text_StyleUsesBalancedMixOfMoves[];
extern const u8 PWT_Text_StyleSampleMessage1[];
extern const u8 PWT_Text_StyleSampleMessage2[];
extern const u8 PWT_Text_StyleSampleMessage3[];
extern const u8 PWT_Text_StyleSampleMessage4[];
extern const u8 PWT_Text_EmphasizesHPAndAtk[];
extern const u8 PWT_Text_EmphasizesHPAndDef[];
extern const u8 PWT_Text_EmphasizesHPAndSpeed[];
extern const u8 PWT_Text_EmphasizesHPAndSpAtk[];
extern const u8 PWT_Text_EmphasizesHPAndSpDef[];
extern const u8 PWT_Text_EmphasizesAtkAndDef[];
extern const u8 PWT_Text_EmphasizesAtkAndSpeed[];
extern const u8 PWT_Text_EmphasizesAtkAndSpAtk[];
extern const u8 PWT_Text_EmphasizesAtkAndSpDef[];
extern const u8 PWT_Text_EmphasizesDefAndSpeed[];
extern const u8 PWT_Text_EmphasizesDefAndSpAtk[];
extern const u8 PWT_Text_EmphasizesDefAndSpDef[];
extern const u8 PWT_Text_EmphasizesSpeedAndSpAtk[];
extern const u8 PWT_Text_EmphasizesSpeedAndSpDef[];
extern const u8 PWT_Text_EmphasizesSpAtkAndSpDef[];
extern const u8 PWT_Text_EmphasizesHP[];
extern const u8 PWT_Text_EmphasizesAtk[];
extern const u8 PWT_Text_EmphasizesDef[];
extern const u8 PWT_Text_EmphasizesSpeed[];
extern const u8 PWT_Text_EmphasizesSpAtk[];
extern const u8 PWT_Text_EmphasizesSpDef[];
extern const u8 PWT_Text_NeglectsHPAndAtk[];
extern const u8 PWT_Text_NeglectsHPAndDef[];
extern const u8 PWT_Text_NeglectsHPAndSpeed[];
extern const u8 PWT_Text_NeglectsHPAndSpAtk[];
extern const u8 PWT_Text_NeglectsHPAndSpDef[];
extern const u8 PWT_Text_NeglectsAtkAndDef[];
extern const u8 PWT_Text_NeglectsAtkAndSpeed[];
extern const u8 PWT_Text_NeglectsAtkAndSpAtk[];
extern const u8 PWT_Text_NeglectsAtkAndSpDef[];
extern const u8 PWT_Text_NeglectsDefAndSpeed[];
extern const u8 PWT_Text_NeglectsDefAndSpAtk[];
extern const u8 PWT_Text_NeglectsDefAndSpDef[];
extern const u8 PWT_Text_NeglectsSpeedAndSpAtk[];
extern const u8 PWT_Text_NeglectsSpeedAndSpDef[];
extern const u8 PWT_Text_NeglectsSpAtkAndSpDef[];
extern const u8 PWT_Text_NeglectsHP[];
extern const u8 PWT_Text_NeglectsAtk[];
extern const u8 PWT_Text_NeglectsDef[];
extern const u8 PWT_Text_NeglectsSpeed[];
extern const u8 PWT_Text_NeglectsSpAtk[];
extern const u8 PWT_Text_NeglectsSpDef[];
extern const u8 PWT_Text_RaisesMonsWellBalanced[];
extern const u8 PWT_Text_Round1Match1[];
extern const u8 PWT_Text_Round1Match2[];
extern const u8 PWT_Text_Round1Match3[];
extern const u8 PWT_Text_Round1Match4[];
extern const u8 PWT_Text_Round1Match5[];
extern const u8 PWT_Text_Round1Match6[];
extern const u8 PWT_Text_Round1Match7[];
extern const u8 PWT_Text_Round1Match8[];
extern const u8 PWT_Text_Round2Match1[];
extern const u8 PWT_Text_Round2Match2[];
extern const u8 PWT_Text_Round2Match3[];
extern const u8 PWT_Text_Round2Match4[];
extern const u8 PWT_Text_SemifinalMatch1[];
extern const u8 PWT_Text_SemifinalMatch2[];
extern const u8 PWT_Text_FinalMatch[];
extern const u8 PWT_Text_LetTheBattleBegin[];
extern const u8 PWT_Text_TrainerWonUsingMove[];
extern const u8 PWT_Text_TrainerBecameChamp[];
extern const u8 PWT_Text_TrainerWonByDefault[];
extern const u8 PWT_Text_TrainerWonOutrightByDefault[];
extern const u8 PWT_Text_TrainerWonNoMoves[];
extern const u8 PWT_Text_TrainerWonOutrightNoMoves[];
