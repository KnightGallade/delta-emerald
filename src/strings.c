...
const u8 gText_ExpandedPlaceholder_Rival[] = _("RIVAL PLACEHOLDER");
...
// Random nicknames
const u8 gText_WallyZigzagoonNickname[] = _("Ziggy");
// Not in strings.h, don't know why
...
const u8 gText_RivalName[] = _("RIVAL'S NAME?");
