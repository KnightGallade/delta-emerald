...
const u32 gObjectEventPic_Leader_Koga[] = INCBIN_U32("graphics/object_events/pics/people/pwt/leader_koga.4bpp");
const u16 gObjectEventPal_Leader_Koga[] = INCBIN_U16("graphics/object_events/palettes/pwt/leader_koga.gbapal");
