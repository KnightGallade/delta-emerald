const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BRENDAN_EMERALD] = TRAINER_PIC_BRENDAN_EMERALD,
    [FACILITY_CLASS_BRENDAN_RS] = TRAINER_PIC_BRENDAN_RS,
    [FACILITY_CLASS_BRENDAN_ORAS] = TRAINER_PIC_BRENDAN_ORAS,
    [FACILITY_CLASS_MAY_EMERALD] = TRAINER_PIC_MAY_EMERALD,
    [FACILITY_CLASS_MAY_RS] = TRAINER_PIC_MAY_RS,
    [FACILITY_CLASS_MAY_ORAS] = TRAINER_PIC_MAY_ORAS,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BRENDAN_EMERALD] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_BRENDAN_RS] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_BRENDAN_ORAS] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_MAY_EMERALD] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_MAY_RS] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_MAY_ORAS] = TRAINER_CLASS_RIVAL,
