const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ORAS_BRENDAN] = TRAINER_PIC_ORAS_BRENDAN,
    [FACILITY_CLASS_ORAS_MAY] = TRAINER_PIC_ORAS_MAY,
    [FACILITY_CLASS_LEADER_BROCK] = TRAINER_PIC_LEADER_BROCK,
    [FACILITY_CLASS_LEADER_MISTY] = TRAINER_PIC_LEADER_MISTY,
    [FACILITY_CLASS_LEADER_LT_SURGE] = TRAINER_PIC_LEADER_LT_SURGE,
    ...
    [FACILITY_CLASS_CHAMPION_BLUE] = TRAINER_PIC_CHAMPION_BLUE,
    ...
    [FACILITY_CLASS_ELITE_FOUR_KOGA] = TRAINER_PIC_ELITE_FOUR_KOGA,
    ...
    [FACILITY_CLASS_ELITE_FOUR_AARON] = TRAINER_PIC_ELITE_FOUR_AARON,
    [FACILITY_CLASS_ELITE_FOUR_BERTHA] = TRAINER_PIC_ELITE_FOUR_BERTHA,
    [FACILITY_CLASS_ELITE_FOUR_FLINT] = TRAINER_PIC_ELITE_FOUR_FLINT,
    [FACILITY_CLASS_ELITE_FOUR_LUCIAN] = TRAINER_PIC_ELITE_FOUR_LUCIAN,
    [FACILITY_CLASS_CHAMPION_CYNTHIA] = TRAINER_PIC_CHAMPION_CYNTHIA,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ORAS_BRENDAN] = TRAINER_CLASS_ORAS_PROTAG,
    [FACILITY_CLASS_ORAS_MAY] = TRAINER_CLASS_ORAS_PROTAG,
    [FACILITY_CLASS_LEADER_BROCK] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_MISTY] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_LT_SURGE] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_ERIKA] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_JANINE] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_SABRINA] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_BLAINE] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_LEADER_GIOVANNI] = TRAINER_CLASS_KANTO_LEADER,
    [FACILITY_CLASS_ELITE_FOUR_LORELEI] = TRAINER_CLASS_KANTO_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_BRUNO] = TRAINER_CLASS_KANTO_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_AGATHA] = TRAINER_CLASS_KANTO_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_LANCE] = TRAINER_CLASS_KANTO_ELITE_FOUR,
    [FACILITY_CLASS_CHAMPION_BLUE] = TRAINER_CLASS_KANTO_CHAMPION,
    [FACILITY_CLASS_LEADER_FALKNER] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_BUGSY] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_WHITNEY] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_MORTY] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_CHUCK] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_JASMINE] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_PRYCE] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_LEADER_CLAIR] = TRAINER_CLASS_JHOTO_LEADER,
    [FACILITY_CLASS_ELITE_FOUR_WILL] = TRAINER_CLASS_JHOTO_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_KOGA] = TRAINER_CLASS_JHOTO_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_KAREN] = TRAINER_CLASS_JHOTO_ELITE_FOUR,
    ...
    [FACILITY_CLASS_LEADER_ROARK] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_GARDENIA] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_MAYLENE] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_CRASHER_WAKE] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_FANTINA] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_BYRON] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_CANDICE] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_LEADER_VOLKNER] = TRAINER_CLASS_SINNOH_LEADER,
    [FACILITY_CLASS_ELITE_FOUR_AARON] = TRAINER_CLASS_SINNOH_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_BERTHA] = TRAINER_CLASS_SINNOH_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_FLINT] = TRAINER_CLASS_SINNOH_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_LUCIAN] = TRAINER_CLASS_SINNOH_ELITE_FOUR,
    [FACILITY_CLASS_CHAMPION_CYNTHIA] = TRAINER_CLASS_SINNOH_CHAMPION,
};
