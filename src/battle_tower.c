...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_BRENDAN_EMERALD, FACILITY_CLASS_BRENDAN_EMERALD},
    {RS_FACILITY_CLASS_BRENDAN_RS, FACILITY_CLASS_BRENDAN_RS},
    {RS_FACILITY_CLASS_BRENDAN_ORAS, FACILITY_CLASS_BRENDAN_ORAS},
    {RS_FACILITY_CLASS_MAY_EMERALD, FACILITY_CLASS_MAY_EMERALD},
    {RS_FACILITY_CLASS_MAY_RS, FACILITY_CLASS_MAY_RS},
    {RS_FACILITY_CLASS_MAY_ORAS, FACILITY_CLASS_MAY_ORAS},
