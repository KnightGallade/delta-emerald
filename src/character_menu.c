...
// TODO - maybe have a function swap out parties?
...
{
    u16 species;
    u32 frontSpriteId = GetPlayerTrainerPicIdByCharacterOutfitType(sOutfitMenu->idx, GetAvatarOutfit(sOutfitMenu->idx), 0);
    u32 backSpriteId = GetPlayerTrainerPicIdByCharacterOutfitType(sOutfitMenu->idx, GetAvatarOutfit(sOutfitMenu->idx), 1);
...
static void SetupOutfitMenu_Sprites(void)
{
    // TODO - Continue from here using Github technique
