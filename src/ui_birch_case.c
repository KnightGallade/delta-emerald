...
{
    [BALL_TOP_FIRST]        = {SPECIES_BULBASAUR, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_CHIKORITA, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TREECKO, 5, ITEM_NONE, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_TURTWIG, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_SNIVY, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CHESPIN, 5, ITEM_NONE, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_EEVEE, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_PANSAGE, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_COTTONEE, 5, ITEM_NONE, BALL_POKE},
};

static const struct MonChoiceData sStarterChoicesFire[9] = 
{
    [BALL_TOP_FIRST]        = {SPECIES_CHARMANDER, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_CYNDAQUIL, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, ITEM_NONE, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_CHIMCHAR, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_TEPIG, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_FENNEKIN, 5, ITEM_NONE, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_EEVEE, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_PANSEAR, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_LITWICK, 5, ITEM_NONE, BALL_POKE},
};

static const struct MonChoiceData sStarterChoicesWater[9] = 
{
    [BALL_TOP_FIRST]        = {SPECIES_SQUIRTLE, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_TOTODILE, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_MUDKIP, 5, ITEM_NONE, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_PIPLUP, 5, ITEM_NONE, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_OSHAWOTT, 5, ITEM_NONE, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_FROAKIE, 5, ITEM_NONE, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_EEVEE, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_PANPOUR, 5, ITEM_NONE, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_SPHEAL, 5, ITEM_NONE, BALL_POKE},
};
